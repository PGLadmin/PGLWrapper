	...
	!  OUTPUT
	USE GlobConst !GlobConst+XA,XD,XC
	USE BIPs
	...
	call IdDipprLookup(nComps,idCas,ier,errMsgPas) !UaEosTools
...
subroutine QueryParPureSpead(iComp,iParm,value,iErr)
	...
	enddo
	if(iParm==10)value=a2Coeff(iComp,10)
...
subroutine SetParPureSpead(iComp,iParm,value,iErr)
	...
	enddo
	if(iParm==10)a2Coeff(iComp,10)=value
