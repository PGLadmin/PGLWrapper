...
!c-----------------------------------------------------------------------------
      ...
      call cubgen(ntyp,mtyp,ierr,tKelvin,pMPa,zn,zFactor,fg,ft,fp,fx,aux)
...
!c-----------------------------------------------------------------------------
      ...
      eta0 = 8888d0
      call phasLorraine(j,ider,istab,p0,x,eta0,v0,g0,i3r,ierr)
