...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! Whoohoo !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	if(iErr > 10)then
		...
		if(liq==1.or.LIQ==3)then
			eta=etaAtPmin*0.99  !crude goldenz
			rhoMol_cc=eta/bVolMix
			vTotCc=totMoles/rhoMol_cc
			call FuTptVtot(isZiter,zFactor,aDep,uDep,vTotCc,tKelvin,gmol,nComps,iErrZ)
...
!CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
    ...
    aAssoc=0
    uAssoc=0
    if(iErr < 11)call Wertheim(vMolecNm3,eta,tKelvin,xFrac,nComps,zAssoc,aAssoc,uAssoc,iErrCode)
!	if( ABS(zAssoc) < 1e-11 )print*,'zAssoc ~ 0???'		 !for debugging
	IF(iErrCode)then
		!iErr=iErrCode
		if(LOUD)pause 'Error in FuTptVtot: Wertheim gave error.'
		iErr=12
		return
	endif
