!	Add this file to your project if you want to run the SpeadEos by itself.
!	Subroutines included: PsatEar, NumDervs, FugiDervs, FuVtot, FugiTP	
!CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
Subroutine FuVtot(isZiter,tKelvin,vTotCc,gmol,nComps,chemPo,zFactor,aRes,uRes,iErr) !isZiter=1=> no fugc calculation.
	IMPLICIT DoublePrecision(A-H,O-Z)
	DoublePrecision gmol(*),chemPo(*)
	call FuTptVtot(isZiter,zFactor,aRes,uRes,chemPo,vTotCc,tKelvin,gmol,nComps,iErr)
    return
end Subroutine FuVtot
!CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
Subroutine FugiTP( tKelvin,pMPa,gmol,nComps,LIQ,rhoMol_cc,zFactor,aRes,chemPo,uRes,iErr )
	IMPLICIT DoublePrecision(A-H,O-Z)
	DoublePrecision gmol(*),chemPo(*)
 	CALL FuTpt( tKelvin,pMPa,gmol,nComps,LIQ,chemPo,rhoMol_cc,zFactor,aRes,uRes,iErr )	  !AUG 10
    return
